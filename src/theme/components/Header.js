...
export default (variables = variable) => {
  ...
  const headerTheme = {
    ".span": {
      height: 128,
      "NativeBase.Left": { alignSelf: "flex-start" },
      "NativeBase.Body": {
        alignSelf: "flex-end",
      ...
      "NativeBase.Right": { alignSelf: "flex-start" }
    },
    ".hasSubtitle": {
      "NativeBase.Body": {
        "NativeBase.Title": {
    ...
    "NativeBase.Button": {
      ...
      ".transparent": {
        ...
        "NativeBase.Icon": { color: variables.toolbarBtnColor },
        "NativeBase.IconNB": { color: variables.toolbarBtnColor },
    ...
    ".searchBar": {
      ...
      "NativeBase.Button": {
        ".transparent": {
          "NativeBase.Text": { fontWeight: "500" },
